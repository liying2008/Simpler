package cc.duduhuo.weibores.view;
 ...
 * =======================================================
 */
public class EmoticonIndicator extends LinearLayout {
    ...
    public EmoticonIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        this.setOrientation(HORIZONTAL);
        mMaxHeight = EmoticonUtils.dip2px(mContext, mHeight);
    ...
    public void playTo(int position) {
        ...
        final ImageView imageViewStart = mImageViews.get(position);
        ObjectAnimator animIn1 = ObjectAnimator.ofFloat(imageViewStart, "scaleX", 0.25f, 1.0f);
        ObjectAnimator animIn2 = ObjectAnimator.ofFloat(imageViewStart, "scaleY", 0.25f, 1.0f);
    ...
    public void playBy(int startPosition, int nextPosition) {
        ...
        anim1.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                ObjectAnimator animFil1l = ObjectAnimator.ofFloat(imageViewStart, "scaleX", 1.0f);
